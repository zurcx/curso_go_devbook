...
// CriarPuclicacao adiciona nova publicacao no banco de dados
...
// BuscarPublicacoes traz as publicaoes que apareceriam no feed do usuario
...
// AtualizarPublicacao atualiza a publicação do usuario
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Você não pode atualizar uma publicação de outro usuário"))
		return
	}
...
// DeletarPublicacao Deleta a publicacao do usuario
...
// BuscarPublicacaoPorUsuario traz as publicações por um usuario especifico
